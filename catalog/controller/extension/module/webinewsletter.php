...
class ControllerExtensionModuleWebinewsletter extends Controller {
	...
	public function index($setting) {
		...
		$config_theme = $this->config->get('theme_paybox_directory');
		...
		// } else {
		// 	$this->document->addStyle('catalog/view/theme/paybox/stylesheet/webinewsletter.css');
		// }
		...
		$this->mdata['mode']        = isset($setting['displaymode']) ? $setting['displaymode'] : "paybox";
